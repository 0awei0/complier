...
class Automata:
    ...
    # 画图（使用graphviz
    def draw_automata(self, name, picture_path="../pictures/"):
...
class DFA2MDFA:
    ...
    def __init__(self, dfa_object, path="../pictures/"):
        self.dfa = dfa_object.dfa
        self.build_MDFA(path)
    ...
    def build_MDFA(self, path="../pictures/"):
        ...
        self.mdfa = self.dfa
        self.mdfa.display()
        self.mdfa.draw_automata('mdfa', path)
...
class NFA2DFA:
    ...
    def __init__(self, nfa_object, path="../pictures/"):
        self.nfa = nfa_object.nfa
        # DFA中用大写字母表示状态
        self.alphabet = [chr(i) for i in range(65, 91)]
        self.build_DFA(path)

    def build_DFA(self, picture_path="../pictures/"):
        all_states = dict()
        e_closure = dict()
        count = 0
        # 得到开始状态的e_closure
        ...
        self.dfa = dfa
        self.dfa.display()
        self.dfa.draw_automata('dfa', picture_path)
...
class Regex2NFA:
    ...
    def __init__(self, regex, path="../pictures/"):
        self.regex = regex
        # 合法字符(们)
        self.alphabet = [chr(i) for i in range(65, 91)]
    ...
    def build_NFA(self, picture_path):
        language = set()
        prev = None
        self.stack = []
        self.automata = []
        ...
        self.nfa.display()
        self.nfa.draw_automata('nfa', picture_path=picture_path)
